...
int   N_cycle=60,            // number of total cycles
...
float temp_dena=95,       
      ...
      time_preden=0,         // desired time for predenaturation
      time_dena=60000,            // desired time for denaturation
      time_anneal=40000,          // desired time for annealing
      time_exten=30000,           // desired time for extension
      time_postexten=400000,      // desired time for post extension
